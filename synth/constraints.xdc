...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports io_btn[0]]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports io_btn[1]]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports io_btn[2]]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports io_btn[3]]
...
##USB-RS232 Interface
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports io_uartRx]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports io_uartTx]
...
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][3]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][6]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][0]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][1]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][2]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][4]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][21]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][22]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][23]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][24]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][25]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][26]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][27]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][28]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][29]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][30]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][31]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][13]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][14]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][15]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][16]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][17]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][18]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][19]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][20]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][5]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][7]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][8]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][9]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][11]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][12]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs_reg[1][10]}]
#set_property MARK_DEBUG true [get_nets {cpu/data_path/register_file/regs[0]}]
