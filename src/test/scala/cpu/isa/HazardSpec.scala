...
/** Multi-instruction pipeline stress: forwarding, load-use stalls, x0 handling, and
  * control-flow flushes. Expected values follow sequential RISC-V semantics regardless
  * of how the pipeline achieves them.
  */
